...
;(function(factory) {
            ...
            _.initials = {
                ...
                dates: {
                    en: {
                        ...
                        noEventForToday: "No announcements for today! :)",
                        noEventForThisDay: "No announcements for this day! :)",
    ...
    EvoCalendar.prototype.init = function(init) {
        ...
        if (!$(_.$elements.calendarEl).hasClass('calendar-initialized')) {
            ...
            if (_.windowW <= _.$breakpoints.medium) { // tablet/mobile
    ...
    EvoCalendar.prototype.resize = function() {
        ...
        if (_.windowW <= _.$breakpoints.medium) { // tablet
            _.toggleSidebar(false);
            _.toggleEventList(false);
    ...
    EvoCalendar.prototype.buildTheBones = function() {
        ...
        if (!_.$elements.calendarEl.html()) {
            ...
            // if: _.options.sidebarToggler
            if(_.options.sidebarToggler) {
                $(_.$elements.sidebarEl).append('<span id="sidebarToggler" role="button" aria-pressed title="'+_.initials.dates[_.options.language].closeSidebarText+'"><button class="icon-button"><i class="fa fa-bars"></i></button></span>');
                if(!_.$elements.sidebarToggler) _.$elements.sidebarToggler = $(_.$elements.sidebarEl).find('span#sidebarToggler');
            }
            if(_.options.eventListToggler) {
                $(_.$elements.calendarEl).append('<span id="eventListToggler" role="button" aria-pressed title="'+_.initials.dates[_.options.language].closeEventListText+'"><button class="icon-button"><i class="fas fa-chevron-right"></i></button></span>');
    ...
    ****************/
    ...
    EvoCalendar.prototype.toggleSidebar = function(event) {
        ...
        if (_.windowW <= _.$breakpoints.medium) {
